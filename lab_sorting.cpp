...
int main()
{
	array< pair< string, vector<int>(*)(vector<int>) >, 5 > sortingAlgorithms;
	sortingAlgorithms[0] = make_pair("bubblesort", &bubble_sort );
	sortingAlgorithms[1] = make_pair("selection sort", &selection_sort );
	sortingAlgorithms[2] = make_pair("quicksort", &quick_sort );
	sortingAlgorithms[3] = make_pair("quick inplace", &quick_sort_inplace );
	sortingAlgorithms[4] = make_pair("merge", &merge_sort );
